...
export const textLightPrimary = color(white).alpha(1).hsl();
export const textLightSecondary = color(white).alpha(0.7).hsl();
export const textLightDivider = color(white).alpha(0.54).hsl();
export const textLightDisabled = color(white).alpha(0.12).hsl();
...
export const textDarkDivider = color(textDark).alpha(0.3).hsl();
export const textDarkDisabled = color(textDark).alpha(0.12).hsl();;
